...
const ATHLETE_SCHEMA = {
    ...
    properties: {
        ...
        winds: { ...STR_ARR, description: 'wind 카드(또는 기록카드 안에 풍속 열이 있을 때): 1차~6차 순서대로 6개. "+0.8" "-0.9" "0.0". 파울·패스·시도 없음은 "". 해당 없으면 빈 배열' },
...
module.exports = {
    ...
    cardsToSheets, cardsToWorkbookBuffer, cardsToAnnotations,
};
