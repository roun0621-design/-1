      ...
      try {
        ...
        if (isCombined) {
            ...
            for (const ath of athleteData) {
                ...
                const special = PaceRanking.isStatus(ath.status_code);
                if (!special) rank++;
        ...
        // ============================================================
            ...
            for (const ath of athleteData) {
                ...
                const special = PaceRanking.isStatus(ath.status_code) || ath.bestCleared == null;
                if (!special) {
                    athIdx++;
        ...
        // ============================================================
            ...
            for (const heat of heats) {
                ...
                PaceRanking.assignRanks(athleteData.filter(a => !PaceRanking.isStatus(a.status_code)), PaceRanking.compareDistance);
        ...
        // ============================================================
            ...
            for (const heat of heats) {
                ...
                ranked.sort(PaceRanking.withStatusLast((a, b) => {
                    if (a.best == null && b.best == null) return 0;
                    if (a.best == null) return 1;
                    if (b.best == null) return -1;
                ...
                for (const e of ranked) {
                    ...
                    // 비고: 상태코드는 기록란에, 비고란에는 사유(DQ 규칙 번호 등 심판 비고) · Q/q
                    let remarkStr = '';
                    if (special) remarkStr = e.allResults?.[0]?.remark || '';
