        ...
        try {
            ...
            for (const x of entries) {
                ...
                const ev = { event_id: x.event_id, event_name: x.event_name, gender: x.event_gender, round_type: x.round_type, round_status: x.round_status, category: x.category, parent_event_id: x.parent_event_id,
                    ...
                    result: r ? { time_seconds: r.time_seconds, distance_meters: r.distance_meters, status_code: r.status_code || null, wind: (r.wind != null && r.wind !== '' && isFinite(parseFloat(r.wind))) ? parseFloat(r.wind) : null, place: placeOf.get(r.heat_id + ':' + x.entry_id) || null, heat_count: heatCount.get(Number(x.event_id)) || 0 } : null,
