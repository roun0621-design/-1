        ...
        try {
            ...
            for (const eid of targetEventIds) {
                ...
                for (const row of rows) {
                    ...
                    recipients.push({ athlete_id: row.athlete_id, event_id: eid, athlete_name: row.athlete_name, phone, message });
                }
            }
            ...
            for (const r of recipients) {
                ...
                await db.run(`INSERT INTO sms_log
                    (competition_id, athlete_id, event_id, phone_number, message, status, provider, provider_msg_id, error_message, cost, sent_at, triggered_by)
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
                    competition_id,
                    r.athlete_id,
                    r.event_id,
