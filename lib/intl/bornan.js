...
function parseResults(json) {
    ...
    const out = rows.map(r => {
        ...
        return {
            ...
            record: String(firstKey(r, ['Record', 'Records', 'RecordMark', 'Rec']) || '').trim(),
            raw: r,
        };
    });
    return { rows: out, note, wind };
}
...
module.exports = { EVENT_MAP, ROUND_MAP, SUB_MAP, fetchJson, decodeBody, apiPath, splitEventKey, splitUnitKey, eventName, parseSchedule, parseEventEntries, parseResults, describeResults, markToNumber };
