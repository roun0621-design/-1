...
async function renderCompInfoBar(containerId) {
    ...
    try {
        ...
        const _cibBtnBase = 'white-space:nowrap;font-size:12px;font-weight:600;padding:2px 11px;border:none;border-radius:6px;color:#fff;cursor:pointer;transition:all 0.15s;letter-spacing:0.2px;';
...
function renderCompNoticeButton() {
    ...
    if (!btn) {
        ...
        btn.style.cssText = 'white-space:nowrap;font-size:12px;font-weight:600;padding:2px 11px;border:none;border-radius:6px;color:#fff;cursor:pointer;transition:all 0.15s;letter-spacing:0.2px;background:linear-gradient(135deg,#e0574f,#b23b34);box-shadow:0 2px 6px rgba(178,59,52,0.3);';
        btn.textContent = '공지';
