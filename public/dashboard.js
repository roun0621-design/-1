...
function renderCompVideoButton() {
    ...
    if (!btn) {
        ...
        btn.style.cssText = 'white-space:nowrap;font-size:12px;font-weight:600;padding:2px 11px;border:none;border-radius:6px;color:#fff;cursor:pointer;transition:all 0.15s;letter-spacing:0.2px;background:linear-gradient(135deg,#2a3a6e,#1a2a5e);box-shadow:0 2px 6px rgba(26,42,94,0.3);display:none;';
        btn.textContent = '영상';
